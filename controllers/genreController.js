...
exports.genre_create_post =  [
    ...
    // This uses trim() to remove any trailing/leading whitespace, 
    // checks that the name field is not empty, and then uses escape() to remove any dangerous HTML characters).
